...
public class BuilderQ4
{
    ...
    {
       Student student=new StudentBuilder(17148,1416431027,"Anuj")
                                            .inBranch("Electronics and Communication")
                                            .havingStream("Electronics")
                                            .isHostler(true).build();
        System.out.println(student);
        System.out.println();
        Student student1=new StudentBuilder(17342,141641003,"Rishabh")
